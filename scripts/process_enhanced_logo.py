...
input_path = r"C:\Users\Omux2\.gemini\antigravity\brain\8cc2a539-bdd5-4cc1-b7de-5c1a08902758\enhanced_original_logo_1782005986627.png"
...
# 2. Use rembg
print("Running rembg on enhanced original logo...")
result = remove(img)
...
# 4. Make it square with a tiny margin (5% padding)
